			...
			<br/>
				<input type="checkbox" name="possiblecontextplaylist[]" value="jamais" /> Je ne la réécouterais pas </br>
		       ...
		       <input type="checkbox" name="possiblecontextplaylist[]" value="amis" /> Avec vos amis </br>
		       <input type="checkbox" name="possiblecontextplaylist[]" value="compagnon" /> Avec votre compagnon/compagne </br>

		       <input type="checkbox" name="possiblecontextplaylist[]" value="famille" />Avec votre famille
		       <br/> 
		       <input type="checkbox" name="possiblecontextplaylist[]" value="autre" /> Autre :
		       <br/>
